              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {!user && <p className="font-body text-[11px] text-muted-foreground"><Link to="/login" className="text-primary underline">Sign in</Link> to collect at Blue Bell LEGO Club</p>}
                  </div>
