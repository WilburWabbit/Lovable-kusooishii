...
import { RETURNS_DEFAULTS, type PolicyContent } from '@/lib/content-defaults';
...
export default function ReturnsPage() {
  ...
  const { data: content } = useStorefrontContent('returns', RETURNS_DEFAULTS as unknown as Record<string, unknown>);
