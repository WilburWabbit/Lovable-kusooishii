...
export const tableRegistry: Record<string, CsvTableConfig> = {
  ...
  stock_unit: {
    ...
    columns: [
      ...
      { dbColumn: 'carrying_value', csvHeader: 'carrying_value', type: 'number', mode: 'readonly', required: false },
      { dbColumn: 'serial_or_internal_mark', csvHeader: 'serial_or_internal_mark', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'reservation_id', csvHeader: 'reservation_id', type: 'string', mode: 'editable', required: false },
      ...
      { dbColumn: 'inbound_receipt_line_id', csvHeader: 'inbound_receipt_line_id', type: 'string', mode: 'fk', required: false },
      ...
      { dbColumn: 'supplier_id', csvHeader: 'supplier_id', type: 'string', mode: 'fk', required: false },
      { dbColumn: 'location_id', csvHeader: 'location_id', type: 'string', mode: 'fk', required: false },
  ...
  product: {
    ...
    columns: [
      ...
      { dbColumn: 'brand', csvHeader: 'brand', type: 'string', mode: 'editable', required: false },
      ...
      { dbColumn: 'include_catalog_img', csvHeader: 'include_catalog_img', type: 'boolean', mode: 'editable', required: false },
      ...
      { dbColumn: 'length_cm', csvHeader: 'length_cm', type: 'number', mode: 'editable', required: false },
      { dbColumn: 'width_cm', csvHeader: 'width_cm', type: 'number', mode: 'editable', required: false },
      { dbColumn: 'height_cm', csvHeader: 'height_cm', type: 'number', mode: 'editable', required: false },
      { dbColumn: 'weight_g', csvHeader: 'weight_g', type: 'number', mode: 'editable', required: false },
      { dbColumn: 'weight_kg', csvHeader: 'weight_kg', type: 'number', mode: 'editable', required: false },
      { dbColumn: 'age_mark', csvHeader: 'age_mark', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'age_range', csvHeader: 'age_range', type: 'string', mode: 'editable', required: false },
      ...
      { dbColumn: 'lego_catalog_id', csvHeader: 'lego_catalog_id', type: 'string', mode: 'fk', required: false },
  ...
  sku: {
    ...
    columns: [
      ...
      { dbColumn: 'qbo_parent_item_id', csvHeader: 'qbo_parent_item_id', type: 'string', mode: 'editable', required: false },
  ...
  channel_listing: {
    ...
    columns: [
      ...
      { dbColumn: 'offer_status', csvHeader: 'offer_status', type: 'string', mode: 'editable', required: false },
      ...
      { dbColumn: 'confidence_score', csvHeader: 'confidence_score', type: 'number', mode: 'editable', required: false },
      { dbColumn: 'pricing_notes', csvHeader: 'pricing_notes', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'priced_at', csvHeader: 'priced_at', type: 'date', mode: 'editable', required: false },
      { dbColumn: 'external_url', csvHeader: 'external_url', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'listed_at', csvHeader: 'listed_at', type: 'date', mode: 'editable', required: false },
      { dbColumn: 'channel', csvHeader: 'channel', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'raw_data', csvHeader: 'raw_data', type: 'json', mode: 'readonly', required: false },
  ...
  sales_order: {
    ...
    columns: [
      ...
      { dbColumn: 'club_id', csvHeader: 'club_id', type: 'string', mode: 'fk', required: false },
      ...
      { dbColumn: 'club_commission_amount', csvHeader: 'club_commission_amount', type: 'number', mode: 'readonly', required: false },
      { dbColumn: 'club_discount_amount', csvHeader: 'club_discount_amount', type: 'number', mode: 'readonly', required: false },
      { dbColumn: 'is_test', csvHeader: 'is_test', type: 'boolean', mode: 'editable', required: false },
      { dbColumn: 'doc_number', csvHeader: 'doc_number', type: 'string', mode: 'editable', required: false },
      ...
      { dbColumn: 'qbo_sales_receipt_id', csvHeader: 'qbo_sales_receipt_id', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'qbo_customer_id', csvHeader: 'qbo_customer_id', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'qbo_last_attempt_at', csvHeader: 'qbo_last_attempt_at', type: 'date', mode: 'readonly', required: false },
      { dbColumn: 'qbo_last_error', csvHeader: 'qbo_last_error', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'qbo_retry_count', csvHeader: 'qbo_retry_count', type: 'number', mode: 'readonly', required: false },
      { dbColumn: 'status', csvHeader: 'status', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'global_tax_calculation', csvHeader: 'global_tax_calculation', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'user_id', csvHeader: 'user_id', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'created_at', csvHeader: 'created_at', type: 'date', mode: 'readonly', required: false },
      { dbColumn: 'updated_at', csvHeader: 'updated_at', type: 'date', mode: 'readonly', required: false },
    ],
    fkResolvers: [
      { fkColumn: 'customer_id', csvLookupColumn: 'customer_id', targetTable: 'customer', targetLookupColumn: 'email', targetPkColumn: 'id' },
      { fkColumn: 'club_id', csvLookupColumn: 'club_id', targetTable: 'club', targetLookupColumn: 'id', targetPkColumn: 'id' },
    ],
    exportOrderBy: 'created_at',
    allowDelete: false,
  },
  ...
  sales_order_line: {
    ...
    columns: [
      ...
      { dbColumn: 'tax_code_id', csvHeader: 'tax_code_id', type: 'string', mode: 'fk', required: false },
      { dbColumn: 'vat_rate_id', csvHeader: 'vat_rate_id', type: 'string', mode: 'fk', required: false },
      { dbColumn: 'qbo_tax_code_ref', csvHeader: 'qbo_tax_code_ref', type: 'string', mode: 'readonly', required: false },
      { dbColumn: 'created_at', csvHeader: 'created_at', type: 'date', mode: 'readonly', required: false },
    ],
    fkResolvers: [
      ...
      { fkColumn: 'tax_code_id', csvLookupColumn: 'tax_code_id', targetTable: 'vat_rate', targetLookupColumn: 'qbo_tax_rate_id', targetPkColumn: 'id' },
      { fkColumn: 'vat_rate_id', csvLookupColumn: 'vat_rate_id', targetTable: 'vat_rate', targetLookupColumn: 'qbo_tax_rate_id', targetPkColumn: 'id' },
    ],
    exportOrderBy: 'created_at',
    allowDelete: true,
  ...
  customer: {
    ...
    columns: [
      ...
      { dbColumn: 'first_name', csvHeader: 'first_name', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'last_name', csvHeader: 'last_name', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'company_name', csvHeader: 'company_name', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'email', csvHeader: 'email', type: 'string', mode: 'editable', required: true },
      { dbColumn: 'web_addr', csvHeader: 'web_addr', type: 'string', mode: 'editable', required: false },
  ...
  inbound_receipt: {
    ...
    columns: [
      ...
      { dbColumn: 'tax_total', csvHeader: 'tax_total', type: 'number', mode: 'readonly', required: false },
      { dbColumn: 'currency', csvHeader: 'currency', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'global_tax_calculation', csvHeader: 'global_tax_calculation', type: 'string', mode: 'readonly', required: false },
  ...
  inbound_receipt_line: {
    ...
    columns: [
      ...
      { dbColumn: 'sku_code', csvHeader: 'sku_code', type: 'string', mode: 'editable', required: false },
      { dbColumn: 'condition_grade', csvHeader: 'condition_grade', type: 'string', mode: 'editable', required: false },
