...
function detectOriginChannel(receipt: any): string {
  // ── Priority 1: QBO Location/Store (DepartmentRef) — authoritative ──
  ...
  // ── Priority 2: DocNumber pattern (secondary fallback) ──
  ...
  // NULL DepartmentRef = eBay (business rule)
  return "ebay";
}
