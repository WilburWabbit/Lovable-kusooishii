-- Repair eBay customer identities that were overwritten by QBO dependency
-- upserts using masked @members.ebay.com relay emails as display names.
-- Lovable SQL runner note: no dollar-quoted PL/pgSQL in this migration.
