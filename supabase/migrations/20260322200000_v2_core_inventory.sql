-- ============================================================
-- Admin V2 — Migration 1: Core Inventory Tables
-- New enums, purchase_batches, purchase_line_items,
-- and additive columns on stock_unit, product, sku.
-- ============================================================
...
CREATE TABLE public.purchase_batches (
  id TEXT PRIMARY KEY,                        -- auto-populated by Migration 3 sequence default
...
-- ─── Alter stock_unit — add v2 columns ───
